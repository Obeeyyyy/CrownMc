...
import de.obey.slayer.util.PacketReader;
...
public final class User {
    ...
    public User(final Player player) {
        ...
        this.playerFile = new File(SlayerMain.getInstance().getDataFolder() + "/playerFiles/" + offlinePlayer.getUniqueId().toString() + ".yml");
    ...
    private void updateData() {
        ...
        }.runTask(initializer.getSlayerMain());
    }
