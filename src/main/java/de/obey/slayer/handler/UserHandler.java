...
import de.obey.slayer.backend.enums.StoreType;
...
public final class UserHandler {
    ...
    public boolean isRegistered(final OfflinePlayer target) {
        ...
        final File file = new File(SlayerMain.getInstance().getDataFolder().getPath() + "/playerFiles/" + target.getUniqueId() + ".yml");
    ...
    public boolean register(final Player player) {
        ...
        try {
            ...
            }.runTaskLater(SlayerMain.getInstance(), 15);
