...
import de.obey.slayer.objects.ChatFilter;
...
public final class ChatFilterHandler {
    ...
    private void load() {
        File file = new File(SlayerMain.getInstance().getDataFolder(), "wordFilter.yml");
        if (!file.exists()) {
    ...
    public void save() {
        final File file = new File(SlayerMain.getInstance().getDataFolder(), "wordFilter.yml");
