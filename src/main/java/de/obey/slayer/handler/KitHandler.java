...
import de.obey.slayer.objects.Kit;
...
public final class KitHandler {
    ...
    public void loadKits() {
        final File kitFolder = new File(SlayerMain.getInstance().getDataFolder().getPath() + "/kits");
    ...
    public void createKit(final Player player, final String name) {
        ...
        kitCache.put(name, new Kit(new File(SlayerMain.getInstance().getDataFolder().getPath() + "/kits/" + name + ".yml")));
