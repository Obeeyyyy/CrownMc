    ...
    public void endCoinFlip() {
        ...
        runnable = new BukkitRunnable() {
            ...
            public void run() {
                ...
                SlayerMain.getInstance().getInitializer().getDailyPotHandler().addMoney(amount/10);
                SlayerMain.getInstance().getInitializer().getCoinflipHandler().endCoinFlip(CoinFlip.this, winner);
            }
