...
public final class RangHandler {
    ...
    public void loadRangs() {
        final File file = new File(CrownMain.getInstance().getDataFolder().getPath() + "/Groups");
    ...
    public void createRang(final String name) {
        final File file = new File(CrownMain.getInstance().getDataFolder().getPath() + "/Groups/" + name + ".yml");
